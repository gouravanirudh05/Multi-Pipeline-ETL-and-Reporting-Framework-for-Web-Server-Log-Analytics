...
parsed_lines = FOREACH raw_lines GENERATE
    line AS raw_line,
    logudfs.parse_log_line(line) AS parsed:(
        host:chararray,
        log_date:chararray,
        log_hour:int,
        method:chararray,
